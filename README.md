...
The format of the text file is as below
    ...
    \_\_label\_\_<sentiment><space><Review title>:<Review body>
...
**Based on the result, the accuracy is 89.6 %**
...
<img src="images/positivewords.png" alt="Common words in postive reviews" width="200"/>

**Common words in negative reviews**
<img src="images/negativewords.png" alt="Common words in negative reviews" width="200"/>
...
**The full scale prototype model gave an accuracy of 86.9 %**
...
**The Tensorflow prototype model gave an accuracy of 90.5 %**
...
<img src="deployment/lstm.png" alt="Model structure" width="200"/>

Here is the updated [trainer script](deployment/sentiment_lstm_trainer.py) that uses the LSTM layer

**The Tensorflow LSTM model improved the accuracy to 95.1 %**
...
<img src="deployment/webpage.png" alt="Final webpage" width="200"/>
